export const EmptyEditorImage: React.FC<{ className?: string }> = ({ className }) => {
	return (
		<img
...
export const EmptyEditorText: React.FC<{
	className?: string
	tag?: string
}> = ({ className, tag }) => {
	const Comp: React.ElementType = tag || 'span'

	return <Comp className={className}>[No text in field]</Comp>
}
